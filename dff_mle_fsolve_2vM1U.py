...
This code generates a random sample from a mixture of two von Mises on CIRCLE 
    and one uniform distribution, with weights p1, p2 and (1-p1-p2) 
...
p1 = 0.3 # weight contribution of the 1st von Mises 
p2 = 0.3 # weight contribution of the 1st von Mises 
